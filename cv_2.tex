...
\moveleft.5\hoffset\centerline{\large\bf Fabio Blasutto} % Your name at the top
 
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip % Horizontal line after name; adjust line thickness by changing the '1pt'
 
\moveleft.5\hoffset\centerline{Via Corrdao II il Salico 30} % Your address
\moveleft.5\hoffset\centerline{Milano(MI), Italy}
\moveleft.5\hoffset\centerline{0039 3803612213}
